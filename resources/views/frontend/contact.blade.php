			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="contact_form">
						...
						<form action="{{route('contact.contact_massage')}}" method="POST" role="form" enctype="multipart/form-data" class="comment_form">
							@csrf
							<div>
							...
							<div>
								...
								<input type="text" name="e_mail" class="comment_input" required="required">
							</div>
							<div>
								<div class="form_title">Message</div>
								<textarea class="comment_input comment_textarea" name="massage" required="required"></textarea>
							</div>
							<div>
