...
<div class="home">
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(public/images/home_slider_1.jpg)"></div>
			...
			<div class="row features_row">
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						<div class="feature_icon"><img src="public/images/icon_1.png" alt=""></div>
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						<div class="feature_icon"><img src="public/images/icon_2.png" alt=""></div>
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						<div class="feature_icon"><img src="public/images/icon_3.png" alt=""></div>
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						<div class="feature_icon"><img src="public/images/icon_4.png" alt=""></div>
	...
	<div class="courses">
		<div class="section_background parallax-window" data-parallax="scroll" data-image-src="public/images/courses_background.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
			...
			<div class="row courses_row">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="public/images/course_1.jpg" alt=""></div>
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="public/images/course_2.jpg" alt=""></div>
						<div class="course_body">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="public/images/course_3.jpg" alt=""></div>
						<div class="course_body">
	...
	<div class="counter">
		<div class="counter_background" style="background-image:url(public/images/counter_background.jpg)"></div>
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
			...
			<div class="row events_row">
				...
				<div class="col-lg-4 event_col">
					<div class="event event_left">
						<div class="event_image"><img src="public/images/event_1.jpg" alt=""></div>
				...
				<div class="col-lg-4 event_col">
					<div class="event event_mid">
						<div class="event_image"><img src="public/images/event_2.jpg" alt=""></div>
						<div class="event_body d-flex flex-row align-items-start justify-content-start">
							<div class="event_date">
								<div class="d-flex flex-column align-items-center justify-content-center trans_200">
				...
				<div class="col-lg-4 event_col">
					<div class="event event_right">
						<div class="event_image"><img src="public/images/event_3.jpg" alt=""></div>
						<div class="event_body d-flex flex-row align-items-start justify-content-start">
							<div class="event_date">
								<div class="d-flex flex-column align-items-center justify-content-center trans_200">
		...
		<div class="container">
			...
			<div class="row team_row">
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="public/images/team_1.jpg" alt=""></div>
						<div class="team_body">
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="public/images/team_2.jpg" alt=""></div>
						<div class="team_body">
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="public/images/team_3.jpg" alt=""></div>
						<div class="team_body">
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="public/images/team_4.jpg" alt=""></div>
						<div class="team_body">
				...
				<div class="col-lg-7 news_col">
					...
					<div class="news_post_large_container">
						<div class="news_post_large">
							<div class="news_post_image"><img src="public/images/news_1.jpg" alt=""></div>
