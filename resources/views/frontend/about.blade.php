...
@section('others_css')
<link rel="stylesheet" type="text/css" href="{{ asset('public/styles/about.css'); }}">
<link rel="stylesheet" type="text/css" href="{{ asset('public/styles/about_responsive.css'); }}">
@endsection
@section('content')
<!-- Home -->
...
<div class="home">
			...
			<div class="row about_row">
				...
				<div class="col-lg-4 about_col about_col_left">
					<div class="about_item">
						<div class="about_item_image"><img src="{{ asset('public/images/about_1.jpg'); }}" alt=""></div>
				...
				<div class="col-lg-4 about_col about_col_middle">
					<div class="about_item">
						<div class="about_item_image"><img src="{{ asset('public/images/about_2.jpg'); }}" alt=""></div>
				...
				<div class="col-lg-4 about_col about_col_right">
					<div class="about_item">
						<div class="about_item_image"><img src="{{ asset('public/images/about_3.jpg'); }}" alt=""></div>
	...
	<div class="feature">
		<div class="feature_background" style="background-image:url(public/images/courses_background.jpg)"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
			...
			<div class="row feature_row">
				...
				<div class="col-lg-6 feature_col">
					<div class="feature_video d-flex flex-column align-items-center justify-content-center">
						<div class="feature_video_background" style="background-image:url(public/images/video.jpg)"></div>
				...
				<div class="col">
					<div class="partners_slider_container">
						<div class="owl-carousel owl-theme partners_slider">
							...
							<!-- Partner Item -->
							<div class="owl-item partner_item"><img src="public/images/partner_1.png" alt=""></div>

							<!-- Partner Item -->
							<div class="owl-item partner_item"><img src="public/images/partner_2.png" alt=""></div>

							<!-- Partner Item -->
							<div class="owl-item partner_item"><img src="public/images/partner_3.png" alt=""></div>

							<!-- Partner Item -->
							<div class="owl-item partner_item"><img src="public/images/partner_4.png" alt=""></div>

							<!-- Partner Item -->
							<div class="owl-item partner_item"><img src="public/images/partner_5.png" alt=""></div>

							<!-- Partner Item -->
							<div class="owl-item partner_item"><img src="public/images/partner_6.png" alt=""></div>
